...
export const PaginationCardMinimal = ({
  ...
  return (
    <div className={cx('border-t border-secondary px-4 py-3 md:px-6 md:pt-3 md:pb-4', className)}>
      ...
      <nav
        aria-label="Pagination"
        className={cx('hidden items-center gap-3 md:flex', align === 'center' && 'justify-between')}
      >
  ...
  return (
    <div className={cx('border-t border-secondary px-4 py-3 md:px-6 md:pt-3 md:pb-4', className)}>
      ...
      >
        ...
        <hr
          className={cx(
            'mx-1 h-4 w-px border-l border-primary max-md:hidden',
            align === 'center' && 'hidden',
          )}
        />

        <div
          className={cx('hidden items-center gap-2 md:flex', align === 'center' && 'order-last')}
        >
